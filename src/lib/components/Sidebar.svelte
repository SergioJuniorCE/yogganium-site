		...
		<div class="sidenav-menu">
			<div class="nav accordion" id="accordionSidenav">
				...
				<a class="nav-link d-sm-none" href="#!">
					<div class="nav-link-icon"><i data-feather="bell" /></div>
					Alerts
				...
				<!-- * * Note: * * Visible only on and above the sm breakpoint-->
				<a class="nav-link d-sm-none" href="#!">
					<div class="nav-link-icon"><i data-feather="mail" /></div>
					Messages
					<span class="badge bg-success-soft text-success ms-auto">2 New!</span>
				</a>
				{#each routeCategories as routeCategorie}
					<div class="sidenav-menu-heading">{routeCategorie.heading}</div>
					{#each routeCategorie.routes as route}
						<a class="nav-link" href="{route.path}">
							<div class="nav-link-icon"><i class="{route.icon}" /></div>
							{route.name}
						</a>
					{/each}
				{/each}
				...
				>
					<div class="nav-link-icon"><i data-feather="activity" /></div>
					Dashboards
					<div class="sidenav-collapse-arrow"><i class="fas fa-angle-down" /></div>
				</a>
				...
				>
					<div class="nav-link-icon"><i data-feather="grid" /></div>
					Pages
					<div class="sidenav-collapse-arrow"><i class="fas fa-angle-down" /></div>
				</a>
				...
				>
					<div class="nav-link-icon"><i data-feather="globe" /></div>
					Applications
					<div class="sidenav-collapse-arrow"><i class="fas fa-angle-down" /></div>
				</a>
				...
				>
					<div class="nav-link-icon"><i data-feather="repeat" /></div>
					Flows
					<div class="sidenav-collapse-arrow"><i class="fas fa-angle-down" /></div>
				</a>
				...
				>
					<div class="nav-link-icon"><i data-feather="layout" /></div>
					Layout
					<div class="sidenav-collapse-arrow"><i class="fas fa-angle-down" /></div>
				</a>
				...
				>
					<div class="nav-link-icon"><i data-feather="package" /></div>
					Components
					<div class="sidenav-collapse-arrow"><i class="fas fa-angle-down" /></div>
				</a>
				...
				>
					<div class="nav-link-icon"><i data-feather="tool" /></div>
					Utilities
					<div class="sidenav-collapse-arrow"><i class="fas fa-angle-down" /></div>
				</a>
				...
				<a class="nav-link" href="charts.html">
					<div class="nav-link-icon"><i data-feather="bar-chart" /></div>
					Charts
				</a>
				<!-- Sidenav Link (Tables)-->
				<a class="nav-link" href="tables.html">
					<div class="nav-link-icon"><i data-feather="filter" /></div>
					Tables
				</a>
			</div>
		</div>
